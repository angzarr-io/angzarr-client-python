...
WIP_SCENARIOS: set[tuple[str, str]] = {
    ...
    (
        "multi_handler.feature",
        "Each saga handles the event once, not once per matching handler method",
    ),
    (
        "multi_handler.feature",
        "Router accepts CommandHandlers in different domains for same command type",
    ),
    (
        "multi_handler.feature",
        "Router accepts a single CommandHandler with multiple handled types",
    ),
    ("multi_handler.feature", "Router rejects duplicate CommandHandler registration"),
    ...
    (
        "projector.feature",
        "A projector instance is reused across all events in one delivery",
    ),
    ("projector.feature", "Each event in the book triggers a handler call"),
    ("projector.feature", "Events from undeclared domains do not fire handlers"),
    ("projector.feature", "Unknown event types are silently skipped"),
    (
    ...
    ("speculative_client.feature", "Invalid speculative request returns error"),
    ("speculative_client.feature", "Multiple speculative executions are independent"),
    ("speculative_client.feature", "Speculative PM requires correlation ID"),
    ("speculative_client.feature", "Speculative PM returns orchestrated commands"),
    ("speculative_client.feature", "Speculative command respects temporal query"),
    ("speculative_client.feature", "Speculative command returns projected events"),
    ("speculative_client.feature", "Speculative command validates business rules"),
    ("speculative_client.feature", "Speculative command with invalid input fails fast"),
    ("speculative_client.feature", "Speculative execution does not affect real state"),
    ("speculative_client.feature", "Speculative execution leaves no trace"),
    (
        "speculative_client.feature",
        "Speculative execution of unavailable service fails",
    ),
    ("speculative_client.feature", "Speculative projector handles event sequence"),
    (
        "speculative_client.feature",
        "Speculative projector returns projection without side effects",
    ),
    ("speculative_client.feature", "Speculative saga respects saga origin"),
    ("speculative_client.feature", "Speculative saga returns commands without sending"),
    (
