"""Step defs for features/client/state_building.feature.

Simulation-style port mirroring tests/steps/state_building.rs in the
Rust client. Validates the aggregate state-reconstruction contract —
snapshot integration, event ordering, Any-wrapped payload dispatch,
next_sequence math — without wiring the real Router replay path.
"""
