"""Step defs for features/client/fact_flow.feature.

Mirrors Rust's tests/steps/fact_flow.rs simulation-style approach:
mock aggregate/saga/fact dataclasses verify the feature scenarios at
a behavioral-shape level. Real fact-injection plumbing is exercised by
the aggregate-level suites; this tier pins the cross-language contract.
"""
