"""Step defs for features/coordinator-contract/merge_strategy.feature.

EXPLICIT SIMULATION — finding #22 in PARITY_AUDIT.md. The feature
describes coordinator-side merge-strategy enforcement (sequence
validation, conflict resolution, retry semantics for STRICT /
COMMUTATIVE / AGGREGATE_HANDLES). Client only sets the proto field;
the simulation here documents the full behavioral contract. Kept
...
scenarios("../coordinator-contract/merge_strategy.feature")
